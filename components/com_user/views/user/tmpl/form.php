...
<tr>
	<td width="120">
		<label for="name">
			<?php echo JText::_( 'Membership number' ); ?>:
		</label>
	</td>
	<td>
...
<tr>
	...
	<td>
		<input class="inputbox required" type="text" id="institution" name="institution" value="<?php echo $this->escape($this->user->get('institution'));?>" size="40" />
	</td>
</tr>
-->
<tr>
